...
\begin{theorem}{}{}
    The set $\omega$ is inductive and is a subset of every inductive set. Hence $\omega$ is the \textbf{smallest inductive set}. 
\end{theorem}
...
\begin{definition}{Transitive Sets}{}
    The set $A$ is called a \textbf{transitive set} if $\forall x \in A(x \subseteq A)$. In other words, every member of $A$ is also a subset of $A$.\\
    or more rigorously
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    Clearly, $0 \in I$. Let $n \in I$. We need to show that $n^{+} \in I$ and just $\bigcup n^{+} \subseteq n^{+}$.\\
